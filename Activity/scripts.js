...
// String - any sequence of characters (backtick or quotation)
...
// substring method
// substrinmg(indexStart, indexend)
...
let x = ['9', '3', '5', '7', '1'];
sortedNum = x.sort((a, b) => a - b)
sortedNum.reverse()
console.log("The second to the highest: " + sortedNum[1])
...
//     const highestInext = number.indexOf(highest);
...
//     numbers.sort(
//         (a, b) => {
//             // if return vakue > 0, sort a after b
